...
- 🟡 **e2e breadth** — manual creation and desktop/mobile offer-copy coverage are now expanding through deterministic Playwright smoke paths; multi-process and error-state e2e coverage remain pending. → grows with each slice
