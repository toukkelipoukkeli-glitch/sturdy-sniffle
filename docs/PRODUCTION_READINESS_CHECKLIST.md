...
- 🟡 **e2e breadth** — manual creation, desktop/mobile validation recovery, and desktop/mobile offer-copy coverage are now expanding through deterministic Playwright smoke paths; multi-process and broader error-state e2e coverage remain pending. → grows with each slice
