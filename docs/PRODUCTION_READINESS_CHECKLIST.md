...
- ✅ **Connector drill-down (linked RFQ/calendar details)** — integration health exposes linked Gmail/calendar records, provider filters, attention empty states, stale/blocked link recovery actions, and connector activity rows for the selected RFQ.
