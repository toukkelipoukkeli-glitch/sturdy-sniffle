...
- ✅ Operator can select RFQs, see workload/capacity/material/outside-services/approval/release panels plus a selected-RFQ workspace audit feed with copyable review export (`App.tsx` triage/costing/offer views).
