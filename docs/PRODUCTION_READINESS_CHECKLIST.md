...
- 🟡 **Loading/empty/stale/error polish** — queue empty states, demo import review states, and a tested workspace error boundary exist; broader skeleton/loading and stale-data states remain pending. → **Slice D**
