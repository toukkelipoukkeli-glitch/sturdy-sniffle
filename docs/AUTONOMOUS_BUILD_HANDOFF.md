...
- Main branch checkpoint: `abc5377` (`Add live adapter outcome commit history (#582)`).
- Open PRs at this checkpoint: none.
- In-flight branch at this checkpoint: `codex/live-adapter-outcome-commit-history-ui` (registry-preview/UI surfacing for persisted live-adapter outcome commit history; no live writes).
