...
- Main branch checkpoint: `dbb43da` (`[codex] Add Integration health provider diagnostics copy (#312)`).
- Open PRs at this checkpoint: none.
- In-flight branch at this checkpoint: `codex/provider-read-diagnostic-actions` adds deterministic next-action items to selected-RFQ provider-read diagnostics in Provider review and Integration health.
