...
- Main branch checkpoint: `75de3a0` (`Add calendar reschedule provider outcomes (#358)`).
...
- Calendar planning for RFQ due holds and offer follow-ups behind adapter boundaries, including local/mock provider outcomes for reviewed reschedule commands while live Calendar writes remain deferred.
