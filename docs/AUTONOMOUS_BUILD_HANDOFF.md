...
- Main branch checkpoint: `eccd94f` (`[codex] Add final gate follow-through execution history (#621)`).
- Open PRs at this checkpoint: none.
- In-flight branch at this checkpoint: `codex/final-gate-follow-through-execution-history-ui` (guarded registry preview surfacing for persisted final-gate follow-through execution history/read summaries).
