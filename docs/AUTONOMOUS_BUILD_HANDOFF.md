...
Last refreshed: 2026-08-07 Europe/Helsinki.
...
- Main branch checkpoint: `e2ab666` (`Refresh live adapter outcome commit handoff (#580)`).
- Open PRs at this checkpoint: none.
- In-flight branch at this checkpoint: `codex/live-adapter-outcome-commit-persistence` (domain-only local persistence for reviewed live-adapter outcome commit plans/runs; no live writes).
