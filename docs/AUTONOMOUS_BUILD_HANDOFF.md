...
- Main branch checkpoint: `e659a79` (`Add live adapter outcome commit persistence (#581)`).
- Open PRs at this checkpoint: none.
- In-flight branch at this checkpoint: `codex/live-adapter-outcome-commit-history` (domain-only history/read-summary for persisted live-adapter outcome commits; no live writes).
