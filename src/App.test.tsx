...
describe("FactoryBid workspace (component)", () => {
  ...
  it("previews non-CNC registry process quotes without enabling fake edits", async () => {
    ...
    expect(adapterStatus).toHaveTextContent("UI controls guarded until process forms are enabled")
    ...
    expect(copiedText).toContain("Selected delta: +EUR 5173.33, +9 days lead")
