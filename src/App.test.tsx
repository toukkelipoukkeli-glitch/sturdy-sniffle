...
describe("FactoryBid workspace (component)", () => {
  ...
  it("renders the dense operator workspace with the first RFQ selected and a computed quote", () => {
    ...
    expect(promotionRecord).toHaveTextContent("Local review record only: 1 record, 1 blocked, 0 candidate.")
  ...
  it("previews non-CNC registry process quotes without enabling fake edits", async () => {
    ...
    expect(wirePromotionRecord).toHaveTextContent("Blocked: non-cnc-promotion:registry-demo:wire-edm:edm-key-077:wire-edm-v1")
