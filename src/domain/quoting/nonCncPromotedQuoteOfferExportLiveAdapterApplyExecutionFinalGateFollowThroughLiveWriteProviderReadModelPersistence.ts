...
function normalizeRecord(
  ...
  const normalized = {
    ...
    blockerLabels: uniqueSorted(record.blockerLabels.map((label) => nonBlank(label, "blockerLabel"))),
    ...
    reviewWarnings: uniqueSorted(record.reviewWarnings.map((warning) => nonBlank(warning, "reviewWarning"))),
