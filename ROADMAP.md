...
- Deterministic offer release command planning and execution audit records for email drafts, lifecycle sent events, calendar follow-up events, workspace status changes, idempotent dry-runs, and manager-reviewed warning gates.
