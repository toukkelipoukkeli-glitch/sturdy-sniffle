...
- Add richer part-review workflows for CAD thumbnails, preview status, browser-native rendering, dimensional checks, manufacturability flags, and operator overrides while keeping heavy geometry parsing behind adapters.
