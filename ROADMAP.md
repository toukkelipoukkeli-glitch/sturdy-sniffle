...
- Offer builder domain model with plain-text offer export, PDF-ready offer document content, export fixtures/snapshots, lifecycle timeline, revision history, customer-facing revision summary/timeline text, and follow-up task tracking.
...
- Expand offer generation with deterministic alternates, customer-ready revision summaries, PDF rendering/export verification, and send/follow-up lifecycle controls; revision summaries now have deterministic customer-facing metadata/timeline text and still need richer terms/alternate copy.
