...
- Add richer persisted connector and calendar drill-downs for follow-up rescheduling controls; connector drill-downs now show deterministic cross-RFQ history plus stale/blocked operator recovery actions.
