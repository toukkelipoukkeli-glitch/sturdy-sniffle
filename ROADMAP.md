...
- Deterministic offer release command planning, execution audit records, run-level fingerprints, and Convex persistence for email drafts, lifecycle sent events, calendar follow-up events, workspace status changes, idempotent dry-runs, and manager-reviewed warning gates.
