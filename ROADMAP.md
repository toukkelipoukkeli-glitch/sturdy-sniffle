...
- Offer builder domain model with plain-text offer export, PDF-ready offer document content, export fixtures/snapshots, lifecycle timeline, revision history, customer-facing revision summary text, and follow-up task tracking.
...
- Expand offer generation with deterministic alternates, customer-ready revision summaries, PDF rendering/export verification, and send/follow-up lifecycle controls; revision summaries now have deterministic customer-facing metadata/text and still need richer multi-revision customer copy.
