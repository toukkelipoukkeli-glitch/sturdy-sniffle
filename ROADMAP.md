...
- Add richer persisted connector and calendar drill-downs for cross-RFQ history and follow-up rescheduling controls; stale/blocked connector links now produce deterministic operator recovery actions.
