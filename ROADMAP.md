...
- Deterministic offer release command planning for email drafts, lifecycle sent events, calendar follow-up events, workspace status changes, and manager-reviewed warning gates.
