...
- Add production hardening for non-CNC promotion package review, seeded demo import/export pre-write reviews, audit-log views, loading/error states, accessibility checks, and responsive QA coverage.
