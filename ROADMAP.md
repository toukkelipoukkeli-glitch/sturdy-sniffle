...
- Offer builder domain model with plain-text offer export, PDF-ready offer document content, export fixtures/snapshots, lifecycle timeline, revision history, customer-facing revision/alternate/terms summary text, release-plan send/follow-up summaries, and follow-up task tracking.
...
- Expand offer generation with deterministic alternates, customer-ready revision summaries, PDF rendering/export verification, and send/follow-up lifecycle controls; revision, alternate, terms, and release-plan send summaries now have deterministic customer-facing/operator text and release-plan UI wiring, with provider send wiring still guarded for later.
