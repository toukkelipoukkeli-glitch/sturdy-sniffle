...
- Non-CNC registry quote previews with guarded selector/readiness flows, preview-only process input edits, deterministic promotion plans, local promotion records, ready-only draft payloads, and visible reviewable command-package descriptors before any active RFQ quote or offer mutation.
