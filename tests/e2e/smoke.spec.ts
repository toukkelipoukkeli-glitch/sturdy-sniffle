...
test("runs the quote workspace costing workflow", async ({ page }) => {
  ...
  await expect(providerOutcomeReadModel).toContainText("No calendar provider outcomes")
  await expect(providerOutcomeReadModel.locator(".metric", { hasText: "Expected" })).toContainText("0")
  await expect(providerOutcomeReadModel.locator(".metric", { hasText: "Created" })).toContainText("0")
